...
export const validateLeadMotorInfoListing = z.object({
  date: z
    .string({
...
export type LeadMotorInfoUpdateType = z.infer<typeof validateLeadMotorInfoUpdateSchema>;
export type LeadMotorInfoListingType = z.infer<typeof validateLeadMotorInfoListing>;
