...
router.post("/", authenticate, checkUserRights(3,'can_view'),getUserProfiles); // Get All Users --> Protected
...
router.get("/:id", authenticate, checkUserRights(3,'can_view'), getUserProfile); // Get Single User --> Protected
