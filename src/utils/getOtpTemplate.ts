export const getOTPEmailTemplate = (otp: string | null, name: string) => `
<!DOCTYPE html>
<html>
<head>
<style>
      ...
      <div style="width: 600px; margin: 0px auto">
        ...
        <div>
          <h2
            ...
            "
          >
            Welcome to Jubilee Retail!
          </h2>
          <div style="font-size: 16px; font-weight: 400; color: #354452">
            Hi <b><span style="color: #a10022;">${name}</span></b>,

            <p>
              Welcome to Jubilee Retail! We're excited to have you on board.
            </p>
            <p>
              Please use this <span class="il">OTP: </span>
              <b style="color: #a10022">${otp}</b> to active your account.
            </p>
            <p>
